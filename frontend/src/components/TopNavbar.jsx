...
export default function TopNavbar() {
  ...
  const { setDatasetId, setSummary, setCharts, setReport, isLoading, setIsLoading, datasetId, user, setIsAuthenticated, setUser } = useAppContext();
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <div className="pl-2 relative">
          <button 
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 flex-shrink-0 to-purple-500 text-white shadow-md ring-2 ring-white dark:ring-slate-800 transition-transform hover:scale-105 active:scale-95"
          ...
          {showProfileMenu && (
            <motion.div 
              ...
              className="absolute right-0 mt-3 w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden z-50"
            >
              ...
              <div className="p-2">
                <button 
                  ...
                  className="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                >
                  Settings
                </button>
                <button 
              ...
              <div className="p-2 border-t border-slate-200 dark:border-slate-800">
                <button 
                  ...
                  className="w-full text-left px-4 py-2 text-sm text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-lg transition-colors font-medium"
                >
                  Sign Out
                </button>
              </div>
